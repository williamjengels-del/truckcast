...
export const metadata: Metadata = {
  title: "Privacy Policy — VendCast",
  description: "How VendCast collects, uses, and protects your data.",
};
          ...
          <div className="space-y-8 text-sm leading-relaxed">
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                VendCast is a software-as-a-service product built and operated by Julian Engels
                (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;). VendCast helps food truck
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-3">When you use VendCast, we collect:</p>
              <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                ...
                <li><strong className="text-foreground">Payment data:</strong> billing and subscription information processed by Stripe. VendCast does not store full payment card details.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                <li>Provide the VendCast service — forecasting, performance tracking, and analytics.</li>
            ...
            <section className="rounded-lg border border-primary/30 bg-primary/5 p-5">
              ...
              <p className="text-muted-foreground mb-3">
                VendCast&apos;s forecast engine improves over time as more event data accumulates.
                By default, your event data (including event names, dates, types, locations, sales
                figures, weather conditions, and fee structures) may be accessed by VendCast
                internally to analyze patterns, validate forecast accuracy, and improve the
                forecasting model for all users.
              </p>
              <p className="text-muted-foreground mb-3">
                <strong className="text-foreground">This data is never sold, shared with third parties, or made accessible to other VendCast users.</strong>{" "}
                It is used exclusively by VendCast&apos;s operator (Julian Engels) for internal
              ...
              <p className="text-muted-foreground">
                ...
                . Opting out does not affect the core functionality of VendCast for your account.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                enforced at the database level. No VendCast user can view another user&apos;s events,
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-3">VendCast uses the following third-party services:</p>
              <ul className="list-disc list-inside space-y-2 text-muted-foreground">
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                notify you by email or via an in-app notice. Continued use of VendCast after
