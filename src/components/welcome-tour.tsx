...
const SLIDES = [
  ...
  },
  {
    ...
    body: "Already have events in Airtable, Square, or a spreadsheet? Import them as a CSV. TruckCast auto-detects your columns — no reformatting needed.",
  ...
  },
  {
    ...
    body: "After an event wraps up, enter what you made. TruckCast uses real sales data to calibrate your forecasts over time. The more events you log, the sharper it gets.",
  ...
  },
  {
    ...
    body: "With 10+ past events, TruckCast generates revenue forecasts for each upcoming booking — based on event type, weather, location, and your own history.",
