        ...
        >
          ...
          {!isPro ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-6 text-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold">AI Assistant is a Pro feature</p>
                <p className="text-xs text-muted-foreground mt-1">
                  Ask questions about your events, revenue trends, and forecasts — answered in seconds using your real data.
                </p>
              </div>
              <Link href="/dashboard/upgrade">
                <Button size="sm" className="mt-1">Upgrade to Pro</Button>
              </Link>
            </div>
          ) : (
            <>
